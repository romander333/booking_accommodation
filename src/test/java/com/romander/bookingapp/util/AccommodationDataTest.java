...
import static com.romander.bookingapp.util.AddressDataTest.getAnotherAddress;
import static com.romander.bookingapp.util.AddressDataTest.getAnotherAddressDto;
...
public class AccommodationDataTest {
    ...
    public static Accommodation getAccommodation() {
        ...
        accommodation.setDailyRate(BigDecimal.valueOf(1500.00)
    ...
    public static Accommodation getAnotherAccommodation() {
        ...
        accommodation.setDailyRate(BigDecimal.valueOf(2300.00)
                .setScale(2, BigDecimal.ROUND_HALF_UP));
    ...
    public static AccommodationResponseDto getAccommodationResponseDto() {
        return new AccommodationResponseDto()
                ...
                .setSize("2 bedroom")
                .setAvailability(3)
                .setDailyRate(BigDecimal.valueOf(1500.00)
                        .setScale(2, BigDecimal.ROUND_HALF_UP))
                .setAmenities(getAmenities());
    }
    ...
    public static AccommodationResponseDto getAnotherAccommodationResponseDto() {
        ...
        return new AccommodationResponseDto()
                ...
                .setDailyRate(BigDecimal.valueOf(2300.00)
                        .setScale(2, BigDecimal.ROUND_HALF_UP))
